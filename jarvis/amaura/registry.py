...
CONTENT_FACTORY_AGENTS: tuple[CompanyAgent, ...] = (
    ...
    _agent(
        ...
        ("web_search", "web_fetch", "read_file", "amaura_register_content_asset"),
        ("research", "draft"),
    ...
    _agent(
        ...
        ("read_file", "run_command", "amaura_register_content_asset"),
    ...
    _agent(
        ...
        ("read_file", "create_document", "run_command", "amaura_register_content_asset"),
