...
print(os.environ.get('AMAURA_LOCAL_MODEL', 'nova:3b'), os.environ.get('AMAURA_LOCAL_REVIEW_MODEL', 'qwen2.5-coder:3b'))
PY
)
WORKER_MODEL="${MODELS%% *}"
...
if [[ "$WORKER_MODEL" == "$REVIEWER_MODEL" ]]; then
...
print "Amaura local runtime is certified."
