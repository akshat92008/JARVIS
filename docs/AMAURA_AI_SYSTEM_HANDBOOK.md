...
| Applies to | The 43-employee Amaura Workforce, six workflows, SQLite operating ledger, REST and JARVIS tool surfaces |
...
| Verified baseline | 63 tests passed; focused Ruff and mypy passed; authenticated API smoke passed; wheel built; 1,000-lead stress run passed |
...
| Packaging | Wheel built: `dist/jarvis-1.0.0-py3-none-any.whl` |
...
The live registry contains **43 unique employees**. Every entry below is generated from the implemented registry. Budget is a per-task maximum; model and tool costs are still checked against the task's remaining budget.
...
```bash
cd /Users/ashishsingh/Desktop/JARVIS
...
curl -s -X POST http://127.0.0.1:8000/api/amaura/programmes \
  ...
  -d '{
    ...
    "inputs": {
      ...
      "workspace": "/Users/ashishsingh/Desktop/JARVIS"
    }
  }'
```
...
```bash
PYTHONPATH=/Users/ashishsingh/Desktop/JARVIS \
  /Users/ashishsingh/.cache/codex-runtimes/codex-primary-runtime/dependencies/python/bin/python3 \
