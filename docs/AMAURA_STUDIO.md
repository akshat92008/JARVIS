...
The registry contains 43 roles across the control plane, revenue, delivery, product engineering, content/media, and research. The original 15-role operating kernel remains intact and is extended with dedicated acquisition and content-factory specialists.
